...
var _contracts_json = require('defimist-core/.contracts.json');
var _contracts_json$1 = require('defimist-periphery/.contracts.json');
...
var IDefimistPair = _interopDefault(require('defimist-core/build/IDefimistPair.json'));
var IDefimistFactory = _interopDefault(require('defimist-core/build/IDefimistFactory.json'));
...
Currency.DM = /*#__PURE__*/new Currency(18, 'DM', 'Defimist');
Currency.NATIVE_CURRENCY = (_Currency$NATIVE_CURR = {}, _Currency$NATIVE_CURR[exports.ChainId.MAINNET] = Currency.ETHER, _Currency$NATIVE_CURR[exports.ChainId.RINKEBY] = Currency.ETHER, _Currency$NATIVE_CURR[exports.ChainId.ARBITRUM_TESTNET_V3] = Currency.ETHER, _Currency$NATIVE_CURR[exports.ChainId.SOKOL] = Currency.SPOA, _Currency$NATIVE_CURR[exports.ChainId.DM] = Currency.DM, _Currency$NATIVE_CURR);
var USD = Currency.USD;
var ETHER = Currency.ETHER;
var SPOA = Currency.SPOA;
var DM = Currency.DM;

var _Token$WETH, _Token$WSPOA, _Token$WDM, _Token$DMC, _Token$NATIVE_CURRENC;
/**
...
Token.WDM = (_Token$WDM = {}, _Token$WDM[exports.ChainId.DM] = /*#__PURE__*/new Token(exports.ChainId.DM, '0xe91D153E0b41518A2Ce8Dd3D7944Fa863463a97d', 18, 'WDM', 'Wrapped DM'), _Token$WDM);
Token.DMC = (_Token$DMC = {}, _Token$DMC[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xa1d65E8fB6e87b60FECCBc582F7f97804B725521', 18, 'DMC', 'Defimist Coin'), _Token$DMC[exports.ChainId.RINKEBY] = /*#__PURE__*/new Token(exports.ChainId.RINKEBY, '0x554898A0BF98aB0C03ff86C7DccBE29269cc4d29', 18, 'DMC', 'Defimist Coin'), _Token$DMC[exports.ChainId.DM] = /*#__PURE__*/new Token(exports.ChainId.DM, '0xb90d6bec20993be5d72a5ab353343f7a0281f158', 18, 'DMC', 'Defimist Coin from Ethereum'), _Token$DMC);
Token.NATIVE_CURRENCY_WRAPPER = (_Token$NATIVE_CURRENC = {}, _Token$NATIVE_CURRENC[exports.ChainId.MAINNET] = Token.WETH[exports.ChainId.MAINNET], _Token$NATIVE_CURRENC[exports.ChainId.RINKEBY] = Token.WETH[exports.ChainId.RINKEBY], _Token$NATIVE_CURRENC[exports.ChainId.ARBITRUM_TESTNET_V3] = Token.WETH[exports.ChainId.ARBITRUM_TESTNET_V3], _Token$NATIVE_CURRENC[exports.ChainId.SOKOL] = Token.WSPOA[exports.ChainId.SOKOL], _Token$NATIVE_CURRENC[exports.ChainId.DM] = Token.WDM[exports.ChainId.DM], _Token$NATIVE_CURRENC);
/**
...
var HONEYSWAP_FACTORY_ADDRESS = '0xA818b4F111Ccac7AA31D0BCc0806d64F2E0737D7';
var BAOSWAP_FACTORY_ADDRESS = '0x45de240fbe2077dd3e711299538a09854fae9c9b';
var LEVINSWAP_FACTORY_ADDRESS = '0x965769C9CeA8A7667246058504dcdcDb1E2975A5';
...
var HONEYSWAP_ROUTER_ADDRESS = '0x1C232F01118CB8B424793ae03F870aa7D0ac7f77';
var BAOSWAP_ROUTER_ADDRESS = '0x6093AeBAC87d62b1A5a4cEec91204e35020E38bE';
var LEVINSWAP_ROUTER_ADDRESS = '0xb18d4f69627F8320619A696202Ad2C430CeF7C53';
/**
...
RoutablePlatform.DEFIMIST = /*#__PURE__*/new RoutablePlatform('Defimist', FACTORY_ADDRESS, ROUTER_ADDRESS, INIT_CODE_HASH, defaultSwapFee);
...
RoutablePlatform.HONEYSWAP = /*#__PURE__*/new RoutablePlatform('Honeyswap', (_RoutablePlatform5 = {}, _RoutablePlatform5[exports.ChainId.DM] = HONEYSWAP_FACTORY_ADDRESS, _RoutablePlatform5), (_RoutablePlatform6 = {}, _RoutablePlatform6[exports.ChainId.DM] = HONEYSWAP_ROUTER_ADDRESS, _RoutablePlatform6), '0x3f88503e8580ab941773b59034fb4b2a63e86dbc031b3633a925533ad3ed2b93', _30);
RoutablePlatform.BAOSWAP = /*#__PURE__*/new RoutablePlatform('Baoswap', (_RoutablePlatform7 = {}, _RoutablePlatform7[exports.ChainId.DM] = BAOSWAP_FACTORY_ADDRESS, _RoutablePlatform7), (_RoutablePlatform8 = {}, _RoutablePlatform8[exports.ChainId.DM] = BAOSWAP_ROUTER_ADDRESS, _RoutablePlatform8), '0x0bae3ead48c325ce433426d2e8e6b07dac10835baec21e163760682ea3d3520d', _30);
RoutablePlatform.LEVINSWAP = /*#__PURE__*/new RoutablePlatform('Levinswap', (_RoutablePlatform9 = {}, _RoutablePlatform9[exports.ChainId.DM] = LEVINSWAP_FACTORY_ADDRESS, _RoutablePlatform9), (_RoutablePlatform10 = {}, _RoutablePlatform10[exports.ChainId.DM] = LEVINSWAP_ROUTER_ADDRESS, _RoutablePlatform10), '0x4955fd9146732ca7a64d43c7a8d65fe6db1acca27e9c5b3bee7c3abe5849f441', _30);

var _INITIAL_CACHE_STATE, _PAIR_ADDRESS_CACHE;
var INITIAL_CACHE_STATE = (_INITIAL_CACHE_STATE = {}, _INITIAL_CACHE_STATE[exports.ChainId.MAINNET] = {}, _INITIAL_CACHE_STATE[exports.ChainId.RINKEBY] = {}, _INITIAL_CACHE_STATE[exports.ChainId.ARBITRUM_TESTNET_V3] = {}, _INITIAL_CACHE_STATE[exports.ChainId.SOKOL] = {}, _INITIAL_CACHE_STATE[exports.ChainId.DM] = {}, _INITIAL_CACHE_STATE);
var PAIR_ADDRESS_CACHE = (_PAIR_ADDRESS_CACHE = {}, _PAIR_ADDRESS_CACHE[RoutablePlatform.DEFIMIST.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE[RoutablePlatform.SUSHISWAP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE[RoutablePlatform.UNISWAP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE[RoutablePlatform.HONEYSWAP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE[RoutablePlatform.BAOSWAP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE[RoutablePlatform.LEVINSWAP.name] = /*#__PURE__*/_extends({}, INITIAL_CACHE_STATE), _PAIR_ADDRESS_CACHE);
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, swapFee, protocolFeeDenominator, platform, liquidityMiningCampaigns) {
    if (platform === void 0) {
      platform = RoutablePlatform.DEFIMIST;
    }
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider, platform) {
    try {
      ...
      if (platform === undefined) platform = RoutablePlatform.DEFIMIST;
      ...
      return Promise.resolve(new contracts.Contract(address, IDefimistPair.abi, provider).getReserves()).then(function (_ref) {
        ...
        return Promise.resolve(new contracts.Contract(liquidityToken.address, IDefimistPair.abi, provider).swapFee()).then(function (_Contract$swapFee) {
          var swapFee = _BigInt.call(JSBI, _Contract$swapFee);

          var _BigInt2 = JSBI.BigInt;
          return Promise.resolve(new contracts.Contract(FACTORY_ADDRESS[tokenAmountA.token.chainId], IDefimistFactory.abi, provider).protocolFeeDenominator()).then(function (_Contract$protocolFee) {
  ...
  Fetcher.fetchSwapFee = function fetchSwapFee(liquidityToken, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(liquidityToken.address, IDefimistPair.abi, provider).swapFee()).then(function (_Contract$swapFee2) {
        var _BigInt3$call = _BigInt4.call(JSBI, _Contract$swapFee2);

        return Promise.resolve(new contracts.Contract(FACTORY_ADDRESS[liquidityToken.chainId], IDefimistFactory.abi, provider).feeToSetter()).then(function (_Contract$feeToSetter) {
          return {
            fee: _BigInt3$call,
  ...
  Fetcher.fetchSwapFees = function fetchSwapFees(liquidityTokens, provider) {
    try {
      ...
      var factoryContract = new contracts.Contract(FACTORY_ADDRESS[liquidityTokens[0].chainId], IDefimistFactory.abi, provider);
      var liquidityTokenContract = new contracts.Contract(liquidityTokens[0].address, IDefimistPair.abi, provider);
      var calls = [];
      calls.push({
  ...
  Fetcher.fetchAllSwapFees = function fetchAllSwapFees(chainId, swapFeesCache, provider) {
    ...
    try {
      ...
      var factoryContract = new contracts.Contract(FACTORY_ADDRESS[chainId], IDefimistFactory.abi, provider);
  ...
  Fetcher.fetchProtocolFee = function fetchProtocolFee(chainId, provider) {
    try {
      if (provider === undefined) provider = providers.getDefaultProvider(networks.getNetwork(chainId));
      return Promise.resolve(new contracts.Contract(FACTORY_ADDRESS[chainId], IDefimistFactory.abi, provider)).then(function (factoryContract) {
...
//# sourceMappingURL=defimist-sdk.cjs.development.js.map
