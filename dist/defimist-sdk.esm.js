...
import { mainnet, rinkeby, arbitrumTestnetV3, sokol, dm } from 'defimist-core/.contracts.json';
import { rinkeby as rinkeby$1, mainnet as mainnet$1, arbitrumTestnetV3 as arbitrumTestnetV3$1, sokol as sokol$1, dm as dm$1 } from 'defimist-periphery/.contracts.json';
...
Currency.NATIVE_CURRENCY = (_Currency$NATIVE_CURR = {}, _Currency$NATIVE_CURR[ChainId.MAINNET] = Currency.ETHER, _Currency$NATIVE_CURR[ChainId.RINKEBY] = Currency.ETHER, _Currency$NATIVE_CURR[ChainId.ARBITRUM_TESTNET_V3] = Currency.ETHER, _Currency$NATIVE_CURR[ChainId.SOKOL] = Currency.SPOA, _Currency$NATIVE_CURR[ChainId.DM] = Currency.DM, _Currency$NATIVE_CURR);
...
Token.WDM = (_Token$WDM = {}, _Token$WDM[ChainId.DM] = /*#__PURE__*/new Token(ChainId.DM, '0xe91D153E0b41518A2Ce8Dd3D7944Fa863463a97d', 18, 'WDM', 'Wrapped DM'), _Token$WDM);
Token.DMC = (_Token$DMC = {}, _Token$DMC[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xa1d65E8fB6e87b60FECCBc582F7f97804B725521', 18, 'DMC', 'Defimist Coin'), _Token$DMC[ChainId.RINKEBY] = /*#__PURE__*/new Token(ChainId.RINKEBY, '0x554898A0BF98aB0C03ff86C7DccBE29269cc4d29', 18, 'DMC', 'Defimist Coin'), _Token$DMC[ChainId.DM] = /*#__PURE__*/new Token(ChainId.DM, '0xb90d6bec20993be5d72a5ab353343f7a0281f158', 18, 'DMC', 'Defimist Coin from Ethereum'), _Token$DMC);
Token.NATIVE_CURRENCY_WRAPPER = (_Token$NATIVE_CURRENC = {}, _Token$NATIVE_CURRENC[ChainId.MAINNET] = Token.WETH[ChainId.MAINNET], _Token$NATIVE_CURRENC[ChainId.RINKEBY] = Token.WETH[ChainId.RINKEBY], _Token$NATIVE_CURRENC[ChainId.ARBITRUM_TESTNET_V3] = Token.WETH[ChainId.ARBITRUM_TESTNET_V3], _Token$NATIVE_CURRENC[ChainId.SOKOL] = Token.WSPOA[ChainId.SOKOL], _Token$NATIVE_CURRENC[ChainId.DM] = Token.WDM[ChainId.DM], _Token$NATIVE_CURRENC);
/**
...
RoutablePlatform.HONEYSWAP = /*#__PURE__*/new RoutablePlatform('Honeyswap', (_RoutablePlatform5 = {}, _RoutablePlatform5[ChainId.DM] = HONEYSWAP_FACTORY_ADDRESS, _RoutablePlatform5), (_RoutablePlatform6 = {}, _RoutablePlatform6[ChainId.DM] = HONEYSWAP_ROUTER_ADDRESS, _RoutablePlatform6), '0x3f88503e8580ab941773b59034fb4b2a63e86dbc031b3633a925533ad3ed2b93', _30);
RoutablePlatform.BAOSWAP = /*#__PURE__*/new RoutablePlatform('Baoswap', (_RoutablePlatform7 = {}, _RoutablePlatform7[ChainId.DM] = BAOSWAP_FACTORY_ADDRESS, _RoutablePlatform7), (_RoutablePlatform8 = {}, _RoutablePlatform8[ChainId.DM] = BAOSWAP_ROUTER_ADDRESS, _RoutablePlatform8), '0x0bae3ead48c325ce433426d2e8e6b07dac10835baec21e163760682ea3d3520d', _30);
RoutablePlatform.LEVINSWAP = /*#__PURE__*/new RoutablePlatform('Levinswap', (_RoutablePlatform9 = {}, _RoutablePlatform9[ChainId.DM] = LEVINSWAP_FACTORY_ADDRESS, _RoutablePlatform9), (_RoutablePlatform10 = {}, _RoutablePlatform10[ChainId.DM] = LEVINSWAP_ROUTER_ADDRESS, _RoutablePlatform10), '0x4955fd9146732ca7a64d43c7a8d65fe6db1acca27e9c5b3bee7c3abe5849f441', _30);

var _INITIAL_CACHE_STATE, _PAIR_ADDRESS_CACHE;
var INITIAL_CACHE_STATE = (_INITIAL_CACHE_STATE = {}, _INITIAL_CACHE_STATE[ChainId.MAINNET] = {}, _INITIAL_CACHE_STATE[ChainId.RINKEBY] = {}, _INITIAL_CACHE_STATE[ChainId.ARBITRUM_TESTNET_V3] = {}, _INITIAL_CACHE_STATE[ChainId.SOKOL] = {}, _INITIAL_CACHE_STATE[ChainId.DM] = {}, _INITIAL_CACHE_STATE);
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider, platform) {
    try {
      ...
      return Promise.resolve(new Contract(address, IDefimistPair.abi, provider).getReserves()).then(function (_ref) {
        ...
        return Promise.resolve(new Contract(liquidityToken.address, IDefimistPair.abi, provider).swapFee()).then(function (_Contract$swapFee) {
          ...
          return Promise.resolve(new Contract(FACTORY_ADDRESS[tokenAmountA.token.chainId], IDefimistFactory.abi, provider).protocolFeeDenominator()).then(function (_Contract$protocolFee) {
  ...
  Fetcher.fetchSwapFee = function fetchSwapFee(liquidityToken, provider) {
    try {
      ...
      return Promise.resolve(new Contract(liquidityToken.address, IDefimistPair.abi, provider).swapFee()).then(function (_Contract$swapFee2) {
        var _BigInt3$call = _BigInt4.call(JSBI, _Contract$swapFee2);

        return Promise.resolve(new Contract(FACTORY_ADDRESS[liquidityToken.chainId], IDefimistFactory.abi, provider).feeToSetter()).then(function (_Contract$feeToSetter) {
          return {
            fee: _BigInt3$call,
  ...
  Fetcher.fetchSwapFees = function fetchSwapFees(liquidityTokens, provider) {
    try {
      ...
      var factoryContract = new Contract(FACTORY_ADDRESS[liquidityTokens[0].chainId], IDefimistFactory.abi, provider);
      var liquidityTokenContract = new Contract(liquidityTokens[0].address, IDefimistPair.abi, provider);
      var calls = [];
      calls.push({
  ...
  Fetcher.fetchAllSwapFees = function fetchAllSwapFees(chainId, swapFeesCache, provider) {
    ...
    try {
      ...
      var factoryContract = new Contract(FACTORY_ADDRESS[chainId], IDefimistFactory.abi, provider);
  ...
  Fetcher.fetchProtocolFee = function fetchProtocolFee(chainId, provider) {
    try {
      if (provider === undefined) provider = getDefaultProvider(getNetwork(chainId));
      return Promise.resolve(new Contract(FACTORY_ADDRESS[chainId], IDefimistFactory.abi, provider)).then(function (factoryContract) {
